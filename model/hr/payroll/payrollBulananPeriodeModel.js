...
UserModel.hasMany(Payroll, {
  ...
  as: "hr_payroll_periode_bulanan_create",
});
...
UserModel.hasMany(Payroll, {
  ...
  as: "hr_payroll_periode_bulanan_submit",
});
Payroll.belongsTo(UserModel, {
  foreignKey: "id_user_submit",
  as: "user_submit",
...
UserModel.hasMany(Payroll, {
  ...
  as: "hr_payroll_periode_bulanan_approve",
});
Payroll.belongsTo(UserModel, {
  foreignKey: "id_user_approve",
  as: "user_approve",
...
UserModel.hasMany(Payroll, {
  ...
  as: "hr_payroll_periode_bulanan_pay",
});
Payroll.belongsTo(UserModel, {
  foreignKey: "id_user_pay",
  as: "user_pay",
