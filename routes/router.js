...
router.use("/", require("./finishGood/bapRoute"));
router.use("/", require("./finishGood/stockOpnameRoute"));
...
router.use(
  "/",
  require("./gudangRM/tambahBahanPersiapan/tambahBahanPersiapanRoute"),
);
router.use(
  "/",
...
router.use("/", require("./gudangRM/gudangRawMaterialBookingRoute"));
