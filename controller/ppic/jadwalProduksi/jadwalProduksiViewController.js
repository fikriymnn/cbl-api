...
const jadwalProduksiViewController = {
  ...
  changeLemburMonlyJadwalProduksiView: async (req, res) => {
    ...
    const list_lembur = [
      {
        tanggalLembur: "2025-04-21",
        shift_1: true,
        shift_2: true,
      },
      {
        tanggalLembur: "2025-04-22",
        shift_1: true,
        shift_2: false,
      },
      {
        tanggalLembur: "2025-04-23",
        shift_1: true,
        shift_2: false,
      },
    ];
    ...
    try {
      ...
      const isOvertimeDay = (date, time = null, shiftNum = null) => {
        ...
        const overtimeEntry = list_lembur.find((item) => {
          const formattedOvertimeDate = new Date(item.tanggalLembur)
            .toISOString()
            .split("T")[0];
