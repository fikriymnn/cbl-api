...
const InspeksiRabutService = {
  getInspeksiRabutService: async ({
    id,
    status,
    tahapan,
    periode_tiket,
  ...
  creteInspeksiRabutService: async ({
    tahapan,
    periode_tiket,
    tanggal,
    no_jo,
    ...
    try {
      ...
      throw new Error(error.message || "Failed to create inspeksi rabut");
    }
  },
};

module.exports = InspeksiRabutService;
