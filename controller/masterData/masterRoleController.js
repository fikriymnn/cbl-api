...
const dataAkses = [
  ...
  //master user all
  {
    nama: "Master User All",
    bagian: "user all",
    path_name: "/masteruserall",
    is_dropdown: false,
    is_main: false,
    is_group: false,
    is_active: false,
  ...
  {
    nama: "Breakdown Time",
    bagian: "BREAKDOWN TIME",
    path_name: "/produksi/breakdown",
    is_dropdown: false,
    is_main: false,
    is_group: false,
    is_active: false,
    ...
    parent: [
      {
        ...
        parent: [
          ...
          //path qms
          {
            ...
            bagian: "PENGAJUAN",
            path_name: "/pengajuanallkehrhistory",
            is_dropdown: false,
            is_main: false,
            is_group: false,
            is_active: false,
    ...
    parent: [
      //drop down human resource
      {
        ...
        parent: [
          ...
          //payroll bulanan
          {
            nama: "Payroll Bulanan",
            bagian: "HUMAN RESOURCES",
            path_name: "/hr/payrollbulan",
            is_dropdown: false,
            is_main: false,
            is_group: false,
            is_active: false,
          ...
          //approve payroll
          {
            nama: "Approve Payroll",
            bagian: "HUMAN RESOURCES",
            path_name: "/hr/accpayroll",
            is_dropdown: false,
            is_main: false,
            is_group: false,
            is_active: false,
